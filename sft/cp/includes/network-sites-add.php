    ...
    <form method="post" action="xhr.php" class="xhr-form">
        ...
        <div id="dialog-panel" dwidth="860px">
            <div style="padding-top: 2px;">
                ...
                <div class="field">
                    <label title="The usermame for the SFTrade control panel">Username:</label>
                    <span><input name="username" value="<?php echo $item['username']; ?>" size="25" type="text"></span>
                </div>

                <div class="field">
                    <label title="The network password for the SFTrade (You can found it in Settings > Change Login)">Network
                        Pass:</label>
                    <span><input name="password" value="<?php echo $item['password']; ?>" size="25" type="text"></span>
                </div>

                <div class="field">
                    <label title="The server\owner of this SFTrade installation"
                           style="opacity: .5;">Server\Owner:</label>
                    <span><input name="owner" value="<?php echo $item['owner']; ?>" size="25" type="text"></span>
                </div>

                <div class="field">
                    <label title="The category of this SFTrade installation" style="opacity: .5;">Category:</label>
        ...
        <div id="dialog-help">
            <a href="http://sflash.biz/sft-dist-pub/docs/network-add-site.html" target="_blank"><img
                        src="images/help-22x22.png"></a>
        </div>
