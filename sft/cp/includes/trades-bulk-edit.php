            ...
            <div style="padding-top: 2px;">
              ...
              <fieldset>
                ...
                <div class="field">
                  ...
                  <span>
                    <input type="text" name="color" value="" size="8" id="color">
                  </span>
                ...
                <div class="field">
                  <label class="updatefield">
                    <input type="hidden" name="flag_update[trigger_strings]" value="0" placeholder="thumbs/">
                    Trigger Strings:
                  </label>
                ...
                <div class="field">
                  <label class="updatefield updating">
                    <input type="hidden" name="flag_update[notes]" value="1">
                    Notes:
                  </label>
                  <span><textarea name="notes" rows="5" cols="60"><?php echo ':Edited: ' . date('Y-m-d H:i:s'); ?></textarea></span>
                </div>
              ...
              <fieldset>
                ...
                <div class="field">
                  ...
                  <span>
                    ...
                    <input type="text" name="force_hourly_hours" value="<?php if (!empty($item['force_hourly_end'])) echo ceil((date_create($item['force_hourly_end'])->getTimestamp() - time()) / (60 * 60)); ?>" size="2" maxlength="2" pattern="[0-9]+">
                    hours OR until
...
$('#flag_confirm').click(confirmClicked);
