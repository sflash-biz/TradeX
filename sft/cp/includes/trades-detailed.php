            ...
            <fieldset>
              ...
              <table class="item-table no-wrap fsize-9pt" border="0" cellspacing="0" cellpadding="4" align="center" style="width: 810px; min-width: 810px;">
                ...
                <tbody>
                  ...
                  $color = '#ececec';
                  // Browser detection
                  $browser_regex = '~(MSIE \d+\.\d+|Trident/\d+\.\d+|Firefox/\d+\.\d+|Chrome/\d+\.\d+|Opera/\d+\.\d+|iPhone OS|Android \d+\.\d+|Version/\d+\.\d+|Safari/\d+|Blackberry\d+|Konqueror/\d+\.\d+)~i';
                  $browser_search = array( 'MSIE',              'rv:',               'Version/', 'Firefox/', 'Opera/', 'Safari/', 'Chrome/', 'Konqueror/');
                  $browser_replace = array('Internet Explorer', 'Internet Explorer', 'Safari ',  'Firefox ', 'Opera ', 'Safari ', 'Chrome ', 'Konqueror ');
                  // / Browser detection
                  foreach( $dstats->i_agent as $agent => $amount ):
                      ...
                      // Browser detection
                      if( preg_match($browser_regex, $agent, $matches) )
                      {
                        $agent_short = str_replace($browser_search, $browser_replace, $matches[1]);
                      }
                      // / Browser detection
                  ?>
                  <tr bgcolor="<?php echo $color; ?>">
            ...
            <fieldset>
              ...
              <table class="item-table no-wrap fsize-9pt" border="0" cellspacing="0" cellpadding="4" align="center" style="width: 810px; min-width: 810px;">
                ...
                <tbody>
                  ...
                  <tr bgcolor="<?php echo $color; ?>">
                    <td class="ta-right" style="padding-right: 4px;"><?php echo $counter++; ?></td>
                    <td><div style="width: 550px; overflow: hidden;" title="<?php echo $ref; ?>"><a href="<?php echo $ref; ?>" target="_blank"><?php echo $ref; ?></a></div></td>
                    <td style="padding: 0px;" class="va-middle">
                      <div class="percent-bar ta-right" style="width: <?php echo $percent; ?>%;">
                        <?php if( $percent >= 60 ) echo "<span>$percent%</span>"; ?>
                      </div>
