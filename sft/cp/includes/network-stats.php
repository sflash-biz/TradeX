    ...
    <div id="toolbar">
      <div id="toolbar-content">
        <div id="toolbar-icons">
          ...
          <img src="images/toolbar-separator-2x32.png">
          <a href="http://sflash.biz/sft-dist-pub/docs/network-stats.html" title="Documentation" target="_blank"><img src="images/help-32x32.png" border="0"></a>
        </div>
...
?>
        <tr <?php if( !empty($so->trade['color']) ) echo 'bgcolor="' . $so->trade['color'] . '"'; ?> id="item-<?php echo $id; ?>" class="ta-right<?php if( $so->i_raw_60 === STATS_UNKNOWN ) echo ' unknown'; ?>">
          ...
          <td class="va-middle" style="padding-right: 4px;"<?php if( empty($menu) ): ?> colspan="2"<?php endif; ?>>
            <?php if( !empty($menu) ): ?>
            <a href="<?php echo '//www.' . $site['domain']; ?>" class="cp-login fw-bold" cpurl="<?php echo '//www.' . $site['domain']; ?>" target="_blank"><?php echo $domain; ?></a>
            <a href="<?php echo $site['url']; ?>" class="cp-login fw-bold" cpurl="<?php echo $site['url']; ?>" cppass="<?php echo $site['password']; ?>" cpuser="<?php echo $site['username']; ?>" target="_blank" title="Go To This Site Control Panel"><img src="images/key-16x16.png"></a>
