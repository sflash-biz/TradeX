...
$(function()
{
    ...
    .click(function()
    {
        ...
        if( !dirty || confirm('The currently loaded template has not been saved, are you sure you want to continue?') )
        {
            ...
            $.ajax({
                    async: true,
                    data: 'r=_xEmailTemplatesLoad&template=' + encodeURI(template),
    ...
    <div id="toolbar">
      <div id="toolbar-content">
        <div id="toolbar-icons">
          ...
          <img src="images/toolbar-separator-2x32.png">
          <a href="http://sflash.biz/sft-dist-pub/docs/templates-email.html" title="Documentation" target="_blank"><img src="images/help-32x32.png" border="0"></a>
        </div>
      </div>
    </div>
