        ...
        <form method="post" action="xhr.php" class="xhr-form">
          ...
          <div id="dialog-panel" dwidth="500px">
            <div style="padding-top: 2px;">
              ...
              <div class="field">
                <label class="short updatefield" title="The usermame for the SFTrade control panel">
              ...
              <div class="field">
                <label class="short updatefield" title="The password for the SFTrade control panel">
              ...
              <div class="field">
                <label class="short updatefield" title="The owner of this SFTrade installation">
              ...
              <div class="field">
                <label class="short updatefield" title="The category of this SFTrade installation">
