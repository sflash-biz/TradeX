...
$item['trade_sources'] = is_array($item['trade_sources']) ? $item['trade_sources'] : array(1);
$item['req_field'] = is_array($item['req_field']) ? $item['req_field'] : array(1);
        ...
        <div id="dialog-panel" dwidth="860px">
            <div style="padding-top: 2px;">
                ...
                <div class="field" id="field_infile">
                    ...
                    <span><input name="infile" value="<?php echo $item['infile']; ?>" size="70" type="text"></span>
                </div>

                <div class="field">
                    <label class="short">Output File:</label>
                    <span><input name="outfile" value="<?php echo $item['outfile']; ?>" size="70" type="text"></span>
                </div>
...
<script>
    ...
    $('img[src="images/remove-16x16.png"]')
        .click(function()
        {
