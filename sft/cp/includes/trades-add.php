            ...
            <div style="padding-top: 2px;">
              ...
              <fieldset class="short-labels">
                ...
                <div class="block-center" style="width: 800px;">
                  <div class="fw-bold" style="float: right; display: none;">Enter the trade data, one trade per line</div>
                  <div><span id="data-format"></span></div>
                ...
                <div class="field">
                  <label>Notes:</label>
                  <span><textarea name="notes" rows="5" cols="60"><?php if ($function_name == '_xTradesAdd') echo ':Edited: ' . date('Y-m-d H:i:s'); else echo ':Edited: ' . date('Y-m-d H:i:s'); //echo $item['notes']; ?></textarea></span>
                </div>
              ...
              <fieldset>
                ...
                <div class="field">
                  ...
                  <span><input type="text" name="color" value="<?php echo $item['color']; ?>" size="8" id="color"></span>
                ...
                <div class="field">
                  ...
                  <span><input type="text" name="trigger_strings" value="<?php echo $item['trigger_strings']; ?>" size="60" placeholder="thumbs/"></span>
                </div>
              ...
              <fieldset>
                ...
                <div class="field">
                  ...
                  <span>
                    ...
                    for
                    <input type="text" name="force_hourly_hours" value="<?php if (isset($_REQUEST["force_hourly_hours"])) echo $_REQUEST["force_hourly_hours"]; else {if (!empty($item['force_hourly_end'])) echo ceil((date_create($item['force_hourly_end'])->getTimestamp() - time()) / (60 * 60));} ?>" size="2" maxlength="2" pattern="[0-9]+">
                    hours OR until
                    <input type="text" name="force_hourly_end" value="<?php echo $item['force_hourly_end']; ?>" now="<?php echo date('Y-m-d H:i:s') ?>" size="20" class="datetimepicker">
                  </span>
                </div>
              ...
              <?php //include '__trader-sync.php'; ?>

            </div>
          </div>

          <div id="dialog-help">
            <a href="http://sflash.biz/sft-dist-pub/docs/trade-add.html" target="_blank"><img src="images/help-22x22.png"></a>
          </div>
...
$('input[name="force_hourly_hours"]').change(function() {
  $('input[name="force_hourly_end"]').val('');
});
