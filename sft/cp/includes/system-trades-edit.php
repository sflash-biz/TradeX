        ...
        <form method="post" action="xhr.php" class="xhr-form">
          ...
          <div id="dialog-panel" dwidth="900px">
            <div style="padding-top: 2px;">
              ...
              <div class="field">
                <label>Color:</label>
                <span><input type="text" name="color" value="<?php echo $item['color']; ?>" size="10" id="color"></span>
              </div>
              ...
              <div class="field">
                ...
                <div class="field">
                    <label></label>
                    <span><?php echo form_checkbox('flag_exlude_global', 'Exclude from global stats', $item['flag_exlude_global']); ?></span>
                </div>
