...
$(function()
{
    ...
    //var cookie_trades_hourly = $.cookie(COOKIE_NAME_TRADES) != null ? $.cookie(COOKIE_NAME_TRADES).split('|') : null;
    //
    //$('#trade-stats-hourly')
    //    .tablesorter({
    //        textExtraction: STATS_HOURLY ? statsHourlyTextExtraction : 'simple',
    ...
    //        widgets: ['zebra'],
    //        headers: {0: {sorter: false}},
    //        sortList: cookie_trades_hourly != null ? [[cookie_trades_hourly[0],cookie_trades_hourly[1]]] : null
    //    })
    //    .bind('sortColumn', function(e, sortColumn, sortDirection)
    //    {
    //        $.cookie(COOKIE_NAME_TRADES, sortColumn + '|' + sortDirection, {expires: 365});
    ...
    .click(function()
    {
        ...
        $.ajax({
            async: true,
            data: 'r=_xTradesBulkEditShow&domain=' + selected.join(',')
        });
    });
    ...
    .click(function()
    {
        ...
        $.ajax({
            async: true,
            data: 'r=_xTradesDeleteShow&domain=' + selected.join(',')
        });
    });
    ...
    .click(function()
    {
        ...
        $.ajax({
            async: true,
            data: 'r=_xTradesEmailShow&domain=' + selected.join(',')
        });
    });
    ...
    .click(function()   //.hoverIntent(function()
    {
        //var $container = $(this);
    ...
    $('span.trade-info-container').mouseleave(
        function()
        {
            $('div.trade-info', this).hide();
        }
    ...
    .livequery('click', function()
    {
        ...
        $.ajax({
            async: true,
            data: 'r=_xGrabThumbs&trade=' + encodeURI($(this).attr('trade')),
            success: function(data)
            {
